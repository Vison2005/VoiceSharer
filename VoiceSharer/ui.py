...
QFrame#PanelOuter { background-color: transparent; border: 1px solid #e5e5e5; border-radius: 12px; }
/* 背景透明，留边框 */
QLabel#PanelTitle { font-weight: bold; color: #333333; padding: 4px; font-size: 14px; background-color: transparent; }
/* 标题背景透明 */
...
QCheckBox::indicator, QListWidget::indicator {
    width: 18px; height: 18px; border: 1px solid #d0d0d0; border-radius: 4px; background-color: #ffffff;
}
...
QPushButton#btn_calibrate { background-color: #0078d4; color: white; border: none; }
QPushButton#btn_calibrate:hover { background-color: #006cc0; }
...
/* 滑块蓝色填充 */
QSlider::handle:horizontal { background: #666666; border: 2px solid #666666; width: 16px; height: 16px; margin: -6px 0; border-radius: 9px; }
/* 滑块深灰手柄 */
QSplitter::handle { background-color: transparent; }
QScrollArea { border: none; background-color: transparent; }
/* 滚动区透明无边框 */
QWidget#DeviceCard { background-color: #ffffff; border: 1px solid #e0e0e0; border-radius: 8px; }
/* 卡片样式：白底圆角边框 */
QLabel { color: #000000; }
QLabel#StatusLabel { color: #666666; font-weight: bold; background: transparent; }
"""

DARK_THEME = """
QMainWindow, QWidget { background-color: #202020; color: #ffffff; font-family: "Segoe UI", "Microsoft YaHei"; }
QFrame#PanelOuter { background-color: transparent; border: 1px solid #3b3b3b; border-radius: 12px; }
/* 背景透明，留边框 */
QLabel#PanelTitle { font-weight: bold; color: #cccccc; padding: 4px; font-size: 14px; background-color: transparent; }
/* 标题背景透明 */
QListWidget { background-color: #2d2d2d; border: 1px solid #3b3b3b; border-radius: 8px; outline: none; }
/* 列表背景深灰色，圆角 */
...
QCheckBox::indicator, QListWidget::indicator {
    width: 18px; height: 18px; border: 1px solid #60cdff; border-radius: 4px; background-color: #333333;
}
QCheckBox::indicator:checked, QListWidget::indicator:checked {
    background-color: #60cdff; border-color: #60cdff;
}
...
QPushButton#btn_calibrate { background-color: #60cdff; color: #000000; border: none; }
QPushButton#btn_calibrate:hover { background-color: #50bcd0; }
...
QSlider::sub-page:horizontal { background: #60cdff; border-radius: 3px; }
/* 滑块蓝色填充 */
QSlider::handle:horizontal { background: #888888; border: 2px solid #888888; width: 16px; height: 16px; margin: -6px 0; border-radius: 9px; }
/* 滑块深灰手柄 */
QSplitter::handle { background-color: transparent; }
QScrollArea { border: none; background-color: transparent; }
/* 滚动区透明无边框 */
QWidget#DeviceCard { background-color: #2d2d2d; border: 1px solid #3b3b3b; border-radius: 8px; }
/* 卡片样式：深灰底圆角边框 */
QLabel { color: #ffffff; }
QLabel#StatusLabel { color: #60cdff; font-weight: bold; background: transparent; }
"""
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.resize(1000, 800)  # 稍微加高一点容纳新控件
        ...
        # 第一行：音频源
        input_layout.addWidget(QLabel("音频源输入:"))
        ...
        self.btn_theme.setStyleSheet(
            "QPushButton { border: 1px solid #d0d0d0; border-radius: 4px; background-color: #ffffff; } QPushButton:hover { background-color: #f0f0f0; }")
        ...
        mic_layout.addWidget(QLabel("校准麦克风:"))
        self.combo_mic = QComboBox()
        self.btn_calibrate = QPushButton("自动同步校准")
        self.btn_calibrate.setObjectName("btn_calibrate")  # 特殊样式
        self.btn_calibrate.setFixedHeight(36)

        mic_layout.addWidget(self.combo_mic, 1)
        mic_layout.addWidget(self.btn_calibrate)
        ...
        top_layout.addLayout(mic_layout)
        ...
        # 左侧：深浅模式、开始、停止、开机自启动、最小化托盘（水平排列）
        ...
        self.btn_theme.setCursor(Qt.PointingHandCursor)
        self.btn_theme.setStyleSheet(
            "QPushButton { border: 1px solid #d0d0d0; border-radius: 6px; background-color: #ffffff; } QPushButton:hover { background-color: #f0f0f0; }")
        self.btn_theme.clicked.connect(self.toggle_theme)
        left_controls_layout.addWidget(self.btn_theme)
        ...
        # 最小化托盘
        self.chk_minimize_to_tray = QCheckBox("最小化托盘")

        left_controls_layout.addWidget(self.btn_start)
        left_controls_layout.addWidget(self.btn_stop)
        left_controls_layout.addWidget(self.chk_autostart)
        left_controls_layout.addWidget(self.chk_minimize_to_tray)

        # 包装左侧控件
        left_controls_widget = QWidget()
        left_controls_widget.setLayout(left_controls_layout)
        bottom_layout.addWidget(left_controls_widget, 1)  # stretch factor 1
        ...
        # 状态标签（保留用于兼容性，隐藏）
        self.lbl_status_old = QLabel("状态: 就绪")
        self.lbl_status_old.setStyleSheet("color: #666666; padding: 4px;")
        self.lbl_status_old.hide()
        main_layout.addWidget(self.lbl_status_old)
